...
export default async function SchedulePage() {
  ...
  return <><PageHero eyebrow="2026." title="Raspored" copy="Teren, vrijeme i protivnik — sve što vam treba za sljedeći matchday." word="Igra" image="/images/pexels-sergio-souza-9735734.jpg" /><section className="section"><div className="shell"><ScheduleView matches={scheduled} /></div></section><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(events) }} /></>;
}
