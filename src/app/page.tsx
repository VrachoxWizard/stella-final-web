  ...
  return <>
    ...
    {league && <section id="aktualno" className="announcement-feature announcement-feature--league" aria-labelledby="league-announcement-title">
      <div className="shell announcement-grid">
        <Reveal className="announcement-visual announcement-visual--league">
          <Image src={league.image} alt="Ligaška fotografija uz najavu prijava za sezonu 2026" fill sizes="(max-width: 900px) 100vw, 46vw" />
          <div className="league-poster-copy" aria-hidden="true"><span>Prijave su otvorene</span><strong>Nova sezona<br />19. 9. 2026.</strong><small>ŠC Hotanj · Zagrebački velesajam</small></div>
        </Reveal>
        <Reveal className="announcement-copy">
          <span className="eyebrow">Aktualno · 01</span>
          <h2 id="league-announcement-title">{league.title}</h2>
          <p>Malonogometna liga počinje 19. rujna u ŠC Hotanj na Zagrebačkom velesajmu.</p>
    ...
    {skradin && <section id="kup-skradina" className="announcement-feature announcement-feature--dark announcement-feature--reverse" aria-labelledby="skradin-announcement-title">
      <div className="shell announcement-grid">
        ...
        <Reveal className="announcement-poster">
          <Image src={skradin.image} alt="Službeni plakat Kupa grada Skradina 2026" width={1024} height={1536} sizes="(max-width: 900px) calc(100vw - 28px), 470px" />
        </Reveal>
      </div>
    </section>}
