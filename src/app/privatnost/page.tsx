...
export default function PrivacyPage() {
  return <><PageHero eyebrow="Transparentno i jasno" title="Privatnost" copy="Kako postupamo s podacima povezanima s ovom web-stranicom." word="Fair" /><section className="section section-white"><article className="shell legal">
    ...
    <h2>Medijski sadržaj</h2><p>Fotografije se objavljuju uz odgovarajuće dopuštenje organizatora i sudionika. Za pitanje ili zahtjev povezan s objavljenim sadržajem kontaktirajte nas.</p>
